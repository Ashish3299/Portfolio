...
const ExperienceSection = ({ slice }: ExperienceSectionProps): JSX.Element => {
  ...
  const experience = useAppSelector((state) => state.experience.items);
    ...
    <StyledJobsSection id="jobs" ref={revealContainer}>
      ...
      <div className="inner">
        ...
        >
          ...
          <StyledHighlight $activeTabId={activeTabId.toString()} />
        </StyledTabList>
                  ...
                  >
                    <h3>
                      ...
                      <span className="company">
                        &nbsp;@&nbsp;
                        <PrismicNextLink field={data?.website}>
                          {data?.name}
                        </PrismicNextLink>
                      </span>
                    </h3>
                    ...
                    <p className="range">
                      <span>
                        {data?.startDate} -{" "}
                        {data?.startDate ? data?.startDate : "Present"}
                      </span>
                    </p>
                    <PrismicRichText field={data?.descr} />
                  </StyledTabPanel>
                </CSSTransition>
              );
            })}
...
const StyledHighlight = styled.div<{ $activeTabId: string }>`
  position: absolute;
  top: 0;
  left: 0;
  z-index: 10;
